...
This module implements filtering of scRNA-seq datasets.

**Generated with [OmniBenchmark](https://omnibenchmark.org) v0.4.0.post19+gad9d21300.d20260404**
...
```bash
git clone https://github.com/CHANGE_ME/2-filter.git
cd 2-filter
```
